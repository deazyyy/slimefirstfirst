...
export const multiBuy = async (lotteryContract, price, numbersList, account,referrer) => {
  try {
    return lotteryContract.methods
      .multiBuy(new BigNumber(price).times(new BigNumber(10).pow(18)).toString(), numbersList,referrer)
      .send({ from: account })
